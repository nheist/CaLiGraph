...
def extract_axioms_direct(graph) -> dict:
...
#def _extract_axioms_direct(graph, pattern_confidence, patterns) -> dict:
...
def _extract_axioms(graph, pattern_confidence, patterns) -> dict:
    ...
    for node in graph.nodes.difference({graph.root_node}):
        ...
        for part in graph.get_parts(node):
            ...
            front_prop_axiom = _find_axioms(pattern_confidence, front_pattern_dict, node, node_doc, property_frequencies)
            if front_prop_axiom:
                node_axioms.append(front_prop_axiom)

            back_prop_axiom = _find_axioms(pattern_confidence, back_pattern_dict, node, node_doc, property_frequencies)
            if back_prop_axiom:
                node_axioms.append(back_prop_axiom)

            enclosing_prop_axiom = _find_axioms(pattern_confidence, enclosing_pattern_dict, node, node_doc, property_frequencies)
            if enclosing_prop_axiom:
                node_axioms.append(enclosing_prop_axiom)
...
def _get_axioms_for_node(pattern_confidence, axiom_patterns, node, text_diff, property_frequencies):
    prop_axiom = None
...
def _find_axioms(pattern_confidence, pattern_dict, node, node_doc, property_frequencies):
    ...
    if axiom_patterns:
        ...
        return _get_axioms_for_node(pattern_confidence, axiom_patterns, node, text_diff, property_frequencies)
    return None
